...
public class GPSUtil {
    ...
    public static double[] transform(double lat, double lon) {
        ...
        double mgLat = lat + dLat; double mgLon = lon + dLon; return new double[]{mgLat,mgLon};
    }
    ...
    public static double[] gps84_To_Gcj02(double lat, double lon) {
        ...
        double dLat = transformLat(lon - 105.0, lat - 35.0);
        double dLon = transformLon(lon - 105.0, lat - 35.0);
        double radLat = lat / 180.0 * pi; double magic = Math.sin(radLat);
    ...
    public static double[] gcj02_To_Bd09(double lat, double lon) {
        ...
        double[] gps = {tempLat,tempLon}; return gps;
    }
    ...
    public static double[] bd09_To_Gcj02(double lat, double lon) {
        ...
        double z = Math.sqrt(x * x + y * y) - 0.00002 * Math.sin(y * x_pi);
        double theta = Math.atan2(y, x) - 0.000003 * Math.cos(x * x_pi);
        double tempLon = retain6(z * Math.cos(theta));
        double tempLat = retain6(z * Math.sin(theta));
        double[] gps = {tempLon,tempLat}; return gps;
    }
    ...
    public static double[] bd09_To_gps84(double lat,double lon){
        ...
        gps84[0] = retain6(gps84[0]); gps84[1] = retain6(gps84[1]);
        return gps84;
    }
